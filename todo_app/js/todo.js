...
function show() {
    ...
    for (var i = 0; i< todos.length; i++) {
        ...
        html += '<li>' + todos[i] + '<button class="remove" id="'+ i +'"' + ' onclick="deleteTask('+ i +')"'+'>x</button></li>';
    };
    html += '</ul>';
    // this displays the task as a lkist
...
// new function added for deleting tasks from the list
