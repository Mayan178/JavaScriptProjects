...
function checkWinConditions() {
    ...
    //This condition checks for tie. If none of the above conditions register and 9 squares are selected, the code executes.
        ...
        audio("./media/tie.wav");
        //This function sets a second time before the resetGame is called.
        setTimeout(function () {resetGame(); }, 1000);
    }

    //This fuction checks if an array includes 3 strings.
...
// This function takes a string parameter of the path you set earlier for placement sound ('./media/place.wav')
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        c.moveTo(x1, y1);
        //This method indicates the end point i nour line.
        c.lineTo(x,y);
        //This method set the width of our line.
        c.lineWidth = 10;
        //This method sets the colour of our line.
        c.strokeStyle = "rgba(90, 34, 245, 0.8)";
